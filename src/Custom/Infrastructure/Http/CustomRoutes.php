...
class CustomRoutes extends CustomRoutesProvider
{
    ...
    public static function register(): void
    {
        ...
        Route::prefix(self::$prefix)->group(function () {
            ...
            Route::post('/getUsusarioByEmailBody', [CustomController::class, 'body'])->name('custom.body');
            Route::get('/getUsusarioByEmail/{email}', [CustomController::class, 'getUsusarioByEmail'])->name('custom.getUsusarioByEmail');
        });
    }
}
